    ...
    return (
        <div className='bg-black h-full w-[100%] p-[64px] flex flex-row gap-[99px] max-sm:gap-[50px] justify-between max-lg:p-[32px] max-sm:flex-col max-sm:items-center'>
            <div className='flex items-start flex-col gap-[12px] w-1/2 max-lg:w-full'>
                ...
                <p className='text-[16px] text-[#B1B1B1] max-sm:text-[14px]'>Identify and mitigate vulnerabilities in
                    your web and mobile applications, network infrastructure, and cryptocurrency systems with our expert
                    security testing.</p>
                <p className='text-[16px] text-[#B1B1B1] max-lg:text-[14px]'>Our team of seasoned professionals employs the latest tools and methodologies to thoroughly assess your systems, providing detailed reports and actionable insights. By proactively addressing potential weaknesses, we help you fortify your defenses and maintain a robust security posture.</p>
