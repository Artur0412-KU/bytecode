    ...
    return (
        <div
            ...
            <div className='flex items-start flex-col gap-[20px] w-1/2 max-lg:w-full'>
                ...
                <p className='text-[18px] max-lg:text-[16px] text-[#B1B1B1] max-sm:text-[14px]'>Engage top-tier cybersecurity experts part-time or fractional to  delegate the routine and build a rock-solid cybersecurity program. We'll  guide you to compliance, stress-free.
                </p>
