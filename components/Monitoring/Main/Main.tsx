    ...
    return (
        <div
            ...
            <div className='flex items-start flex-col gap-[20px] w-1/2 max-lg:w-full'>
                ...
                <p className='text-[18px] max-lg:text-[16px] text-[#B1B1B1] max-sm:text-[14px]'>Ensure the ongoing safety of your digital assets by implementing real-time security monitoring across your web applications, networks, and infrastructure.
                </p>
                <p className='text-[18px] max-lg:text-[16px] text-[#B1B1B1] max-sm:text-[14px]'>Our dedicated team utilizes cutting-edge monitoring tools and techniques to provide you with real-time insights into potential threats. By continuously analyzing your security posture and detecting anomalies, we help you respond to incidents swiftly, minimizing the risk of breaches and maintaining the integrity of your systems.</p>
